...
const services = () => {
  ...
  const getServices = async () => {
    const data = await _api_sanityClient__WEBPACK_IMPORTED_MODULE_3__["default"].fetch(`*[_type == "services"]{ 
          title, 
          slug, 
          mainImage{ 
            asset->{ 
